...
// File replacement of My Page ⇔ Account Information Page
    function replaceMypage()
    {
        ...
        if (file_exists($userinfo_file) && file_exists($edituser_file)) {
            if ($xoopsModuleConfig['mypage_use']
                ...
                // Back up account information page ⇒ Replace with My Page
                ...
                // Return to the original state (account information page)
