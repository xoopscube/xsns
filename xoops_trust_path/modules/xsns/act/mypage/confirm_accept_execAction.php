...
class Xsns_Confirm_accept_exec_Action extends Xsns_Mypage_Action
{
    ...
    function dispatch()
    {
        ...
        $user_from =& $user_handler->get($uid_from);    // Requester (other person)
        $user_to =& $user_handler->get($uid_to);        // user himself
        ...
        switch ($mode) {
            ...
            case 4:    // Unregister friends list (confirmation only)
