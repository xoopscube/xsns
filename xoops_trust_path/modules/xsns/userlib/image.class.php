...
class XsnsImageHandler extends XsnsRootHandler
{
    ...
    function uploadImage($prefix, $target, $target_id, $thumb_id = XSNS_IMAGE_SIZE_M)
    {
        ...
        foreach ($image_list as $image) {
            ...
            // Convert temporary file names based on timestamps
